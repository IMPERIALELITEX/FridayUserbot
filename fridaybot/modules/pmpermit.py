...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/70593a1cdb71aaf3ae165.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By IMPERIALELITEX 🇮🇳"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is IMPERIALELITEX PM Protection Service ⚠️**\n\n"
